...
/**
 * @brief Copy cellular data from location library format to location module format
 *
 * @param dest Destination structure
 * @param src Source cellular data from location library
 */
...
/**
 * @brief Copy WiFi data from location library format to location module format
 *
 * @param dest Destination structure
 * @param src Source WiFi data from location library
 */
				     ...
				     const struct location_data_cloud *src)
{
	...
	if (src->cell_data == NULL && src->wifi_data == NULL) {
		LOG_ERR("No cellular or WiFi data to copy");
		return -EINVAL;
	}
