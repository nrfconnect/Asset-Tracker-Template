...
enum cloud_msg_type {
	...
	/* Shadow response messages. Contains the desired section of the shadow set by the cloud. */
	CLOUD_SHADOW_RESPONSE_DESIRED,

	/* Shadow response messages. Contains the delta section of the shadow (desired - reported)
	 * set by the device.
	 */
