...
struct main_state {
	...
	const struct smf_state *running_history;
};
...
static void buffer_disconnected_sampling_entry(void *o)
{
	...
	state_object->running_history = &states[STATE_BUFFER_DISCONNECTED_SAMPLING];
...
static void buffer_disconnected_waiting_entry(void *o)
{
	...
	state_object->running_history = &states[STATE_BUFFER_DISCONNECTED_WAITING];
...
static void buffer_connected_sampling_entry(void *o)
{
	...
	state_object->running_history = &states[STATE_BUFFER_CONNECTED_SAMPLING];
...
static void buffer_connected_waiting_entry(void *o)
{
	...
	state_object->running_history = &states[STATE_BUFFER_CONNECTED_WAITING];
...
static void passthrough_disconnected_entry(void *o)
{
	...
	state_object->running_history = &states[STATE_PASSTHROUGH_DISCONNECTED];
}
...
static void passthrough_connected_sampling_entry(void *o)
{
	...
	state_object->running_history = &states[STATE_PASSTHROUGH_CONNECTED_SAMPLING];
	state_object->sample_start_time = k_uptime_seconds();
...
static void passthrough_connected_waiting_entry(void *o)
{
	...
	state_object->running_history = &states[STATE_PASSTHROUGH_CONNECTED_WAITING];
...
static void fota_run(void *o)
{
	...
	const struct smf_state *resume_state = state_object->running_history;
	...
	if (state_object->chan == &FOTA_CHAN) {
		...
		case FOTA_DOWNLOAD_FAILED:
			if (resume_state != NULL) {
				smf_set_state(SMF_CTX(state_object), resume_state);
			} else {
