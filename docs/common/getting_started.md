...
For pre-built binaries that do not require a build environment, refer to the latest tag in the [release artifacts](release.md) documentation.
...
If you experience issues, check the logs in the serial terminal for any error messages. You can find troubleshooting tips in the [Tooling and Troubleshooting](tooling_troubleshooting.md) section of the documentation.
