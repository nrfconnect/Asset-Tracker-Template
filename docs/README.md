...
For detailed setup including nRF Cloud provisioning and advanced build configurations, see [Getting Started](common/getting_started.md).

## Further reading

* [Getting Started](common/getting_started.md)
* [Architecture](common/architecture.md)
* [Configurability](common/configurability.md)
* [Customization](common/customization.md)
* [Location Services](common/location_services.md)
* [Test and CI Setup](common/test_and_ci_setup.md)
