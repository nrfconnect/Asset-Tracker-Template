...
#define EXPECTED_NEXT_PASS_START_TIME 1770893489LL
#define EXPECTED_NEXT_PASS_END_TIME 1770893669LL
#define EXPECTED_NEXT_PASS_MAX_ELEVATION_TIME 1770893549LL
